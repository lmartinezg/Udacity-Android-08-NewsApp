...
public final class QueryUtils {
    ...
    public static List<NewsItem> fetchNewsItemData(String requestUrl) {
        ...
        // Simulates a slow internet connection
        try {
            Thread.sleep(2000);
    ...
    private static List<NewsItem> extractFeatureFromJson(String newsItemJSON) {
        ...
        try {
            ...
            // Create a JSONObject for the JSON response object
            JSONObject responseJsonObject = baseJsonResponse.getJSONObject("response");

            // Extract the JSONArray associated with the key called "results",
            // which represents a list of features (or NewsItems).
            JSONArray NewsItemArray = responseJsonObject.getJSONArray("results");
            ...
            for (int i = 0; i < NewsItemArray.length(); i++) {
                ...
                String id = currentNewsItem.getString("id");
                ...
                // Create a new {@link NewsLink} object with the magnitude, location, time,
                // and url from the JSON response.

                    NewsItem newsItem = new NewsItem(id, sectionName, webPublicationDate,
                            webTitle, webUrl);
            ...
            Log.e("QueryUtils", "Problem parsing the News Items JSON results", e);
        }
